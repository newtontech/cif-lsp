...
```bash
cif-lsp-tool check path/to/input --format json
cif-lsp-tool context path/to/input --format json
cif-lsp-tool complete path/to/input --format json
cif-lsp-tool hover path/to/input --format json
cif-lsp-tool symbols path/to/input --format json
cif-lsp-tool fix path/to/input --format json
```
